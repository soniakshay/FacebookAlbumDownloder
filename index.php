...
$loginUrl = $helper->getLoginUrl('https://localhost/FacebookAlbumDownloader/page/fb-callback.php');
...
<html>
    ...
    <link rel="stylesheet" href="assets/css/style.css">	<!-- mycss -->
    ...
    <body>
		<div id="container">
			...
			<div id="header">
				<div class="container">
					<center>
					<h1 style="color:white;"><strong>Facebook Album Downloder</strong></h1></center>
